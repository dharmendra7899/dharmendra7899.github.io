...
contactForm: function () {
    $('.rwt-dynamic-form').on('submit', function (e) {
        ...
        var actionURL = _self.attr('action'); // Formsubmit.co URL

        // Create a hidden iframe to submit the form (works with Formsubmit.co redirect)
        var iframe = $('<iframe name="hidden_iframe" style="display:none;"></iframe>');
        $('body').append(iframe);
        _self.attr('target', 'hidden_iframe');
        ...
        iframe.on('load', function() {
            ...
            _self[0].reset();
            setTimeout(function () {
                _self.find('.success-msg').fadeOut('slow');
            }, 5000);
